import { Triggers, IExecuteParam, WebchatFlow, Flow } from 'automation-sdk';

export function troubleshootFlow(){
    const mainFlow = new WebchatFlow("network_coverage_flow", "intern_greeting", "1.0");
    
    mainFlow
        .text(["Troubleshooting Is Still In Development",1])
